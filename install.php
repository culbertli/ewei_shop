...
CREATE TABLE `ims_ewei_shop_goods` (
  ...
  `456wd_id` int(11) NOT NULL,
  `wd_new` int(11) NOT NULL,
...
CREATE TABLE `ims_ewei_shop_groups_order_goods` (
  ...
  PRIMARY KEY (`id`),
  KEY `groups_order_id` (`groups_order_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member` (
  ...
  `old_openid` varchar(60) NOT NULL DEFAULT '',
...
CREATE TABLE `ims_ewei_shop_order_refund` (
  ...
  `endtime` int(11) DEFAULT '0',
  `merchid` int(11) DEFAULT '0',
  `ordergoodsids` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_createtime` (`createtime`),
  KEY `idx_uniacid` (`uniacid`)
...
CREATE TABLE `ims_ewei_shop_verifygoods_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `uniacid` (`uniacid`) USING BTREE,
  KEY `verifygoodsid` (`verifygoodsid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
